...
spawn(function() 
    ...
    wait(.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>👑VietTruongg Hub👑<Color=/>"):Display()
    wait(.14)

end)

local OrionLib = loadstring(game:HttpGet(('https://raw.githubusercontent.com/shlexware/Orion/main/source')))()
local Window = OrionLib:MakeWindow({Name = "VietTruongg Hub", HidePremium = false, IntroText = "VietTruongg Library", SaveConfig = true, ConfigFolder = "VietTruongg Hub"})

OrionLib:MakeNotification({
	Name = "VietTruongg Hub",
...
OrionLib:MakeNotification({
	Name = "VietTruongg Hub",
	Content = "VietTruongg Hub ON TOP",
	Image = "rbxassetid://4483345998",
	Time = 25
})
...
W:AddLabel("Script By VietTruongg")

local Section = W:AddSection({
    Name = "Update"
})

W:AddLabel("[+] VietTruongg Hub is back!")
W:AddLabel("[+] I AM VietTruongg")
W:AddLabel("[+] FB | VietTruongg")
W:AddLabel("[+] 👑")
...
local locallv = W:AddLabel("Level")
    ...
    local LevelFarmFarm W:AddLabel("Kaitun : Chưa Ra")
